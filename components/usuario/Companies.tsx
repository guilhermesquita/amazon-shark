...
const CompaniesComponent = () => {
  ...
  return (
    <div className="p-4 overflow-x-hidden border rounded-lg shadow-md h-full bg-background text-foreground">
      {loading ? (
        <p>Carregando empresas...</p>
      ) : showAddForm ? (
        <AddEmpresa existingCompany={editingCompany} />
      ) : (
        <div className="md:w-[50rem] w-[300px]">
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={7} md={6}>
              <div>
                <h2 className="text-2xl font-semibold mb-4">Minhas empresas</h2>
              </div>
            </Grid>
