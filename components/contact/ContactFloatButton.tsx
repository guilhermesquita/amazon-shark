export default function ContactFloatButton() {
  return (
    <div>
      <div className="group fixed bottom-14 right-5 p-2  flex items-end justify-end w-24 h-24 ">
        <div className="text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 z-50 absolute  ">
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            className="w-6 h-6 ml-1 mb-1 group-hover:rotate-90 transition-all duration-[0.6s]"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
              d="M2.25 6.75a.75.75 0 01.75-.75h3.584a.75.75 0 01.71.527l1.028 3.324a.75.75 0 01-.218.758l-2.065 2.065a11.04 11.04 0 005.689 5.689l2.065-2.065a.75.75 0 01.758-.218l3.324 1.028a.75.75 0 01.527.71v3.584a.75.75 0 01-.75.75h-2.25C8.44 21.75 2.25 15.56 2.25 8.25v-2.25z"
            />
          </svg>
        </div>
